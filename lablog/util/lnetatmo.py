...
_GETSTATIONS_DATA = _BASE_URL + "api/getstationsdata"


class ClientAuth:
    "Request authentication and keep access token available through token method. Renew it automatically if necessary"

    def __init__(self, clientId=config.NETATMO_CLIENT_ID,
                       clientSecret=config.NETATMO_CLIENT_SECRET,
...
class DeviceList:
    ...
    def getStationsData(self,device_id):
        postParams = { "access_token" : self.getAuthToken }
        postParams['device_id']  = device_id

        return postRequest(_GETSTATIONS_DATA, postParams)
