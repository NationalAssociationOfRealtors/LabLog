...
CUBESENSOR_CONSUMER_KEY = os.environ.get('CUBESENSOR_CONSUMER_KEY')
CUBESENSOR_CONSUMER_SECRET = os.environ.get('CUBESENSOR_CONSUMER_SECRET')
CUBESENSOR_ACCESS_TOKEN= os.environ.get('CUBESENSOR_ACCESS_TOKEN')
CUBESENSOR_ACCESS_TOKEN_SECRET= os.environ.get('CUBESENSOR_ACCESS_TOKEN_SECRET')
